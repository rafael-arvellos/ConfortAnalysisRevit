...
namespace ConfortAnalysis.Core.Spatial
{
    ...
    public static class intersectionCommands
    {
        ...
        public static void TraverseBVH(AABBNode? node, TriangulatedSolidOrShell mesh, Ray ray, ref int count)
        {
            if (node == null)
                return;
        ...
        public static bool RayIntersectsAABB(Ray ray, BoundingBoxXYZ bb)
        {
        ...
        public static bool RayTriangleIntersect(Ray ray, (XYZ V0, XYZ V1, XYZ V2) tri, out double t)
        {
